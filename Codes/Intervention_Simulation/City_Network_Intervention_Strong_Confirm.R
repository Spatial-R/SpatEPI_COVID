...
write.csv(dat_day,file = "Process_Data/City_Network_Intervention_Strong_Confirm.csv",row.names = F)


save(origin_model,origin_model_ct,origin_model_fc,origin_model_fcct,
     file = "E:/nCOV/Process_Data/City_Network_Intervention_Strong_Confirm.RData")
