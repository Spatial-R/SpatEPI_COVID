...
spatPomp(case_all_final,
         ...
         partrans=parameter_trans(log=c("alpha","g","R0IN","kappa"),
                                  logit = c("psi","qua","sigma","gamma","quawh","qualow","rho","omega","quatar",
                                            paste0("S",1:U,"_0"),
                                            paste0("E",1:U,"_0"),
                                            paste0("J",1:U,"_0"),
                                            paste0("P",1:U,"_0"),
...
startparameter <- profileDesign(quatar = seq(from=min_tar,to = max_tar,length = 20),
  ...
  #names(startparameter)[1] <- name.paremeter
  ...
  write.csv(global.result,file=paste("Hope_Qua_3_",pro_n,".csv",sep=""),row.names = F)
